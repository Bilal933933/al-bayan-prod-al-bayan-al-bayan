...
const statItems = [
    {
        ...
        bgColor:
            'bg-gradient-to-br from-palette-1/10 to-palette-1/20 dark:from-palette-1/20 dark:to-palette-1/30',
    ...
    },
    {
        ...
        bgColor:
            'bg-gradient-to-br from-palette-2/10 to-palette-2/20 dark:from-palette-2/20 dark:to-palette-2/30',
    ...
    },
    {
        ...
        bgColor:
            'bg-gradient-to-br from-palette-4/10 to-palette-4/20 dark:from-palette-4/20 dark:to-palette-4/30',
        borderColor: 'border-palette-4/30 dark:border-palette-4/40',
    },
    {
        icon: Trophy,
        label: 'متوسط النتيجة',
        getValue: (s: StatsGridProps['stats']) =>
            s.average_percentage !== null ? `${s.average_percentage}%` : '—',
        iconColor: 'text-palette-3',
        bgColor:
            'bg-gradient-to-br from-palette-3/10 to-palette-3/20 dark:from-palette-3/20 dark:to-palette-3/30',
    ...
    },
    {
        ...
        label: 'أيام المواظبة',
        getValue: (s: StatsGridProps['stats']) =>
            s.streak_days !== undefined ? `${s.streak_days} يوم` : '—',
        iconColor: 'text-orange-500',
        bgColor:
            'bg-gradient-to-br from-orange-500/10 to-orange-500/20 dark:from-orange-500/20 dark:to-orange-500/30',
