        ...
        <div className="w-72">
            <div className="mb-3 flex items-center justify-between">
                ...
                <span className="text-xs text-muted-foreground">
                    {answeredQuestions.size} من {totalQuestions} مُجاب
                </span>
            </div>
                ...
                {Array.from({ length: totalQuestions }, (_, i) => {
                    ...
                    return (
                        ...
                        >
                            {i + 1}
                            {isFlagged && (
                                <span className="absolute -top-0.5 -right-0.5 flex h-3 w-3 items-center justify-center rounded-full bg-warning">
                                    <Flag className="fill-warning-foreground text-warning-foreground h-2 w-2" />
                                </span>
                            )}
                        </button>
                    );
            ...
            <div className="mx-auto flex max-w-4xl items-center justify-between gap-4 px-4 py-3">
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        ...
                        className={cn(
                            'gap-1.5',
                            isFlagged && 'text-warning hover:text-warning/80',
                        )}
                        aria-label={
                            isFlagged
                                ? 'إزالة العلم من هذا السؤال'
                                : 'تحديد هذا السؤال للمراجعة'
                        }
                    >
                        <Flag
                            className={cn(
                                'h-4 w-4',
                                isFlagged && 'fill-warning',
                            )}
                        />
