...
export function StickyUserBar({ currentUser }: StickyUserBarProps) {
    ...
    return (
        <div className="fixed right-0 bottom-0 left-0 z-50 border-t border-slate-100 bg-white/80 backdrop-blur-md">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
                ...
                {currentUser.points_to_next_rank > 0 && (
                    <div className="text-center text-sm text-slate-500">
                        ...
                        <span className="font-bold text-emerald-600">
                            <SlidingNumber
                                number={currentUser.points_to_next_rank}
                                thousandSeparator=","
                                inView
                            />
                        </span>{' '}
                ...
                <div className="text-right">
                    <span className="flex items-center gap-1 rounded-full bg-emerald-50 px-3 py-1 text-xs font-medium text-emerald-600">
                        ...
                        <SlidingNumber
                            number={currentUser.streak_days}
                            inView
                        />{' '}
                        يوم متتالي
                    </span>
