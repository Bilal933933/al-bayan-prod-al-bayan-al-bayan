                        ...
                        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                            <div className="flex items-center gap-3">
                                <Link
                                    ...
                                    className={`${textClass} opacity-70 transition-opacity hover:opacity-100`}
                                >
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    />
                                    <h1
                                        className={`text-2xl font-bold sm:text-3xl ${textClass}`}
                                    >
                                        {competition.name}
                                    </h1>
                                </div>
                    ...
                    >
                        <div className="mb-4 flex items-center justify-between">
                            ...
                            <Link
                                href={
                                    competitions.create({
                                        query: { parent_id: competition.id },
                                    }).url
                                }
                            >
                                <Button size="sm">
                        ...
                        {competition.children.length === 0 ? (
                            <div className="flex flex-col items-center justify-center rounded-xl border border-dashed p-12 text-center">
                                ...
                                <p className="text-muted-foreground">
                                    لا توجد مسابقات فرعية.
                                </p>
                                <p className="mt-0.5 text-sm text-muted-foreground/60">
                                    يمكنك إضافة أول مسابقة فرعية بالضغط على الزر
                                    أعلاه.
                                </p>
                            </div>
                        ) : (
                                ...
                                {competition.children.map((child, index) => (
                                    ...
                                    >
                                        <Link
                                            href={
                                                competitions.show({
                                                    competition: child.slug,
                                                }).url
                                            }
                                            className="group relative block overflow-hidden rounded-xl border bg-card shadow-sm transition-all hover:-translate-y-1 hover:shadow-md"
                                        >
                                            {child.color && (
                                                <div
