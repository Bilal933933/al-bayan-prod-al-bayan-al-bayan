            ...
            >
                ...
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                    <ResultStatsCard
                        ...
                        sub={
                            overallStats.completed_count > 0
                                ? `${overallStats.completed_count} مكتملة`
                                : undefined
                        }
                    />
                    <ResultStatsCard
                        ...
                        label="متوسط النتيجة"
                        value={
                            overallStats.average_percentage !== null
                                ? `${overallStats.average_percentage}%`
                                : '—'
                        }
                        sub={
                            overallStats.best_score > 0 &&
                            overallStats.average_percentage !== null
                                ? `أفضل درجة: ${overallStats.best_score}`
                                : undefined
                        }
                    />
                    <ResultStatsCard
                        ...
                        value={formatDuration(overallStats.total_seconds)}
                    />
                    <ResultStatsCard
                        icon={Play}
                        label="قيد التنفيذ"
                        value={overallStats.in_progress_count}
                    />
                </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-xs text-muted-foreground">
                                    التظلم، الفحص الطبي، استكمال المستندات،
                                    التعيين — كل ما تحتاج معرفته بعد ظهور
                                    النتيجة.
                                </p>
                                <Link
                ...
                {overallStats.total_attempts === 0 && (
                    <div className="flex flex-col items-center justify-center gap-3 rounded-xl border border-dashed py-20">
                        ...
                        <p className="text-sm text-muted-foreground/60">
                            ابدأ بحل بعض التمارين أو المسابقات لترى نتائجك هنا.
                        </p>
                    </div>
                )}
            </motion.div>
